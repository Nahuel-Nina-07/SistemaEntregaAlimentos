        ...
        <div class="row">
            <div class="col-md-4">
                <div class="profile-img">
                    <img src="{{ $solicitud->LogoImg }}" alt="{{ $solicitud->NombreNegocio }}">
                </div>
            </div>
            <div class="col-md-6">
                <div class="profile-head">
                    <h5>
                        {{ $solicitud->NombreNegocio }} {{ $solicitud->apellido_solicitante }}
                    </h5>
                    <h6>
                        {{ $solicitud->id}}
                    </h6>
                ...
                <div class="tab-content profile-tab" id="myTabContent">
                    <div class="tab-pane fade show active" id="datos-usuario" role="tabpanel" aria-labelledby="home-tab">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <p>{{ $solicitud->NombreNegocio }} {{ $solicitud->apellido_solicitante }}</p>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
